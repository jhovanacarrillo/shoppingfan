    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/img/fondo4.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption">
              <h5>Bienvenido a ShoppingFan</h5>
                              <p>Observa las ofertas y obtén los artículos que desees</p>
                              <p><a href="#" class="btn btn-warning mt-3">Learn More</a></p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="../../assets/img/fondo5.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption">
              <h5>Bienvenido a ShoppingFan</h5>
			  <p>Observa las ofertas y obtén los artículos que desees</p>
			  <p><a href="#" class="btn btn-warning mt-3">Learn More</a></p>
          ...
          <div class="carousel-item">
            <img src="../../assets/img/fondo6.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption">
				<h5>Bienvenido a ShoppingFan</h5>
              
				<p>Observa las ofertas y obtén los artículos que desees</p>
                              <p><a href="#" class="btn btn-dark mt-3">Comenzar</a></p>
            </div>
          </div>
        </div>
